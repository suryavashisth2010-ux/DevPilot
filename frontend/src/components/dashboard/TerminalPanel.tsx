...
export function TerminalPanel({ logs }: TerminalPanelProps) {
  ...
  return (
    <aside className="hidden lg:flex w-96 border-l border-white/5 bg-black/60 flex flex-col backdrop-blur-3xl z-10 shadow-[-30px_0_60px_rgba(0,0,0,0.4)] shrink-0">
